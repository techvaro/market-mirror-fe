      ...
      <div className="group relative flex flex-col justify-between overflow-hidden rounded-xl border border-border bg-card shadow-xs transition-all hover:shadow-md cursor-pointer h-full">
          ...
          <div className="relative aspect-square w-full overflow-hidden bg-muted">
            {!product.stock ? (
              <div className="absolute inset-0 bg-background/80 backdrop-blur-[2px] flex items-center justify-center">
                <span className="text-[10px] font-bold text-muted-foreground border-2 border-muted-foreground px-2 py-0.5 rounded uppercase">
                  Out of Stock
                </span>
              </div>
            ) : (
              <span className="absolute top-1.5 left-1.5 bg-gray-500 text-white text-[9px] font-extrabold px-1.5 py-0.5 rounded shadow-sm uppercase">
                ONLY FEW LEFT
              </span>
            )}
          </div>
          ...
          <div className="p-2 flex flex-col gap-0.5">
            ...
            <div className="flex items-center gap-1 text-[10px] text-muted-foreground mt-0.5">
              <div className="flex items-center text-muted-foreground">
                <Star className="w-2.5 h-2.5 fill-muted-foreground text-muted-foreground" />
                <span className="font-bold ml-0.5 text-foreground">{product.rating}</span>
              </div>
              <span className="text-border">|</span>
              <div className="flex items-center text-muted-foreground font-medium truncate">
                <Flame className="w-2.5 h-2.5 fill-muted-foreground text-muted-foreground mr-0.5 shrink-0" />
            ...
            <div className="inline-block mt-0.5">
              <span className="bg-muted text-muted-foreground text-[9px] font-bold px-1.5 py-0.5 rounded">
                BEST-SELLING ITEM
              </span>
            </div>
          </div>
        ...
        <div className="p-2 pt-0 flex items-end justify-between mt-auto">
          <div className="flex flex-col">
            <span className="text-[9px] text-muted-foreground font-bold leading-none mb-0.5">
              Last day
            </span>
