    ...
    if (validate()) {
      ...
      toast({
        ...
        description: accountType === 'vendor'
          ? "You have successfully signed in to your vendor account."
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              ...
              {/* Email or Phone Input Container matching the layout */}
              <div className="space-y-1.5">
                ...
                {/* Link sitting directly beneath the input on the left */}
